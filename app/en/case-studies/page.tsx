    ...
    <main>
      <section className="py-10 md:py-14 hero-gradient-enhanced">
        <div className="max-w-[1140px] mx-auto px-6">
          ...
          <h1 className="text-4xl font-bold text-[var(--text)] mb-3">Illustrative Scenarios</h1>
            ...
            {content.items.map((cs) => (
              ...
              >
                ...
                <div className="space-y-2 text-sm text-[var(--text-secondary)]">
                  ...
                  <div className="flex gap-2">
                    <span className="font-semibold text-[var(--text)] min-w-[130px]">Possible approach:</span>
                    <span>{cs.approach}</span>
                  </div>
                  <div className="flex gap-2">
                    <span className="font-semibold text-[var(--text)] min-w-[130px]">Target state:</span>
                    <span>{cs.result}</span>
                  </div>
                </div>
