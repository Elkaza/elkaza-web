...
export const siteContent = {
  ...
  caseStudies: {
    de: {
      title: "Referenzen",
      subtitle: "Technische Fallstudien mit messbarer Wirkung.",
      items: [
        {
          ...
          result: "VPN-Ausfälle wurden beseitigt, die Wi-Fi-Abdeckung ist konsistent, und die Netzwerkinfrastruktur ist vollständig dokumentiert.",
        ...
        },
        {
          ...
          result: "MFA ist jetzt überall umgesetzt, Backup-Restore ist getestet, und die Audit-Readiness ist deutlich verbessert.",
        ...
        },
        {
          ...
          result: "Risky Sign-ins werden blockiert, externe Zugriffe sind kontrolliert, und die Identitätsgrundlage ist jetzt auditierbar.",
        ...
        },
        {
          ...
          result: "Die Recovery-Strategie ist jetzt durch getrennte Backups und regelmäßige Tests praktisch abgesichert.",
        ...
        },
        {
          ...
          result: "Freigaben sind auf Least Privilege reduziert, externe Shares sind begrenzt, und der Audit-Trail ist vollständig.",
    ...
    en: {
      title: "Case Studies",
      subtitle: "Engineering case studies with measurable impact.",
      items: [
        {
          ...
          result: "VPN outages were eliminated, Wi-Fi coverage became consistent, and the network is now fully documented.",
        ...
        },
        {
          ...
          result: "MFA is now in place across the organization, backup restore is tested, and audit readiness has improved significantly.",
          metrics: "Security Score: 32% → 85%, Patch Compliance: 45% → 95%, MFA: 0% → 100%",
          tools: "Microsoft 365 Premium, Veeam Backup, Bitwarden",
        },
        {
          ...
          result: "Risky sign-ins are blocked, external access is controlled, and the identity foundation is now auditable.",
        ...
        },
        {
          ...
          result: "Recovery readiness is now backed by separate backups and regularly tested drills.",
        ...
        },
        {
          ...
          result: "Sharing is reduced to least privilege, external shares are constrained, and the audit trail is complete.",
